  ...
  lead_upload: {
    ...
    properties: [
      ...
      },
      {
        ...
        options: [
          { label: 'Yes', value: 'yes' },
          { label: 'No (In-Memory)', value: 'no' },
        ],
        description: 'Whether to permanently store these leads or process in-memory only',
      },
    ],
  },
  ai_message: {
    ...
    properties: [
      {
        ...
        type: 'number',
        defaultValue: 30,
        description: 'Seconds to wait before taking the No Reply branch',
      },
    ],
  },
  follow_up: {
    ...
    properties: [
      {
        ...
        label: 'Spreadsheet ID',
        type: 'text',
        placeholder: 'Google Sheets document ID (e.g. 1I13UGr... )',
      },
      {
        key: 'worksheet_name',
        label: 'Worksheet Name',
